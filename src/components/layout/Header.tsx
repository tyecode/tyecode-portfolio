          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              {NAVIGATION_LINKS.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-gray-600 hover:text-gray-900 text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 rounded-md px-2 py-1"
                >
                  {link.label}
                </a>
              ))}
            ...
            <div className="md:hidden">
              <button
                ...
                className="text-gray-600 hover:text-gray-900 p-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 rounded-md"
